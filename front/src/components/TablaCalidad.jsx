...
import LineChartComponent from "../medit/LineChartDual";
...
const TablaCalidad = () => {
    ...
    const selectSx = {
        "& .MuiOutlinedInput-root": {
            ...
            "& fieldset": { borderColor: isDarkMode ? "#4ade80" : "#4caf50" },
            "&:hover fieldset": { borderColor: isDarkMode ? "#22c55e" : "#388e3c" },
    ...
    return (
        <div className="p-3 sm:p-2  max-sm:p-2 max-sm:mt-0">
                        ...
                        onClick={() => {
                            if (fechaInputRef.current) {
                                ...
                                try {
                                    ...
                                    // showPicker no disponible en este navegador
                                }
                            }
                        }}
                    >
            ...
            <div className="flex flex-col lg:flex-row gap-4 w-full px-2 max-sm:px-0 max-sm:gap-2">
                ...
                <div className="w-full lg:w-1/2 overflow-x-auto rounded-xl shadow-lg mt-2 max-sm:mt-1 max-sm:rounded-lg border-2 border-gray-300 dark:border-gray-700">
                                ...
                                {dataCalidad.length > 0 ? (
                                    dataCalidad.map((row, index) => (
                                        ...
                                        >
                                            ...
                                            <td
                                                className={`px-1 py-1 text-center text-sm sm:text-xl font-bold max-sm:text-xs ${row.tipO_PESO === "BAJO PESO"
                                                    ? "text-red-500"
                                            ...
                                            <td
                                                className={`px-1 py-1 text-center text-sm sm:text-xl font-bold max-sm:text-xs  ${row.porcentaje >= 5 && row.porcentaje < 7
                                                    ? "text-green-500"
                ...
                <div className="w-full lg:w-1/3 flex flex-col gap-1 h-auto lg:h-[calc(100vh-100px)] lg:overflow-hidden max-sm:gap-1 max-sm:h-auto">
                    {/* Gráfico 1 */}
                    <div className="rounded-xl shadow-lg bg-white dark:bg-gray-900 h-[300px] sm:h-[400px] lg:h-[50%] max-sm:h-[250px] border-2 border-gray-300 dark:border-gray-700">
                ...
                <div className="w-full lg:w-1/5 flex flex-col gap-1 h-auto lg:h-[calc(100vh-100px)] lg:overflow-hidden justify-center items-center sm:gap-2 sm:py-2">
                    {/* medidor conforme */}
                    <div className="w-full flex-1 bg-white dark:bg-gray-900 rounded-xl shadow-lg flex flex-col justify-center sm:min-w-[120px] sm:h-[200px]  border-2 border-gray-300 dark:border-gray-700">
